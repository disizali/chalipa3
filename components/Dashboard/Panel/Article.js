...
export default class Article extends Component {
  ...
  componentDidMount() {
    ...
    axios.get("http://http://95.216.86.208:3000/api/articles").then(({ data }) => {
  ...
  sendPost() {
    ...
    axios
      .post("http://http://95.216.86.208:3000/api/articles", {
        title,
        body,
        selectedImage
      })
  ...
  deletePost(targetId) {
    ...
    axios
      .delete("http://http://95.216.86.208:3000/api/articles", { data: { targetId } })
      .then(({ data }) => {
        if (data == "no article") {
          return;
        }
