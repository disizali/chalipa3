...
export default class News extends Component {
  ...
  componentDidMount() {
    ...
    axios.get("http://http://95.216.86.208:3000/api/news").then(({ data }) => {
  ...
  sendNews() {
    ...
    axios
      .post("http://http://95.216.86.208:3000/api/news", {
        title,
        body,
        image: selectedImage
      })
  ...
  deleteNews(targetId) {
    ...
    axios
      .delete("http://http://95.216.86.208:3000/api/news", { data: { targetId } })
      .then(({ data }) => {
        if (data == "no news") {
          return;
        }
